...
// Only modified namespace to csharp for this sample application to be more platform independent (dotnet core), otherwise:
// <auto-generated>
//     This code was generated by google-apis-code-generator 1.5.1
//     Build date: 2018-10-16 23:51:10 UTC
//     on: 2019-05-23, 12:34:26 UTC
...
{    
    ...
    public class BoardingAndSeatingInfo : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The value of passenger seat.
        ///
        /// eg: "25A" or "stand by"</summary>
    ...
    public class CommonWalletObjectClassCallbackOptions : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>URL for the merchant endpoint that would be called for all user saves and deletes. The URL should
        /// be hosted on HTTPS and robots.txt should allow the URL path to be accessible by UserAgent:Google-
        /// Valuables.</summary>
    ...
    public class DateTime : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// UTC.
        ///
        /// 1985-04-12T19:20:50.52-04:00 would be 20 minutes and 50.52 seconds after the 19th hour of April 12th, 1985,
        /// 4 hours before UTC (same instant in time as the above example). If the date/time is intended for a physical
        /// location in New York, this would be the equivalent of Eastern Daylight Time (EDT). Remember that offset
        /// varies in regions that observe Daylight Saving Time (or Summer Time), depending on the time of the year.
        ///
        /// 1985-04-12T19:20:50.52 would be 20 minutes and 50.52 seconds after the 19th hour of April 12th, 1985 with no
        /// offset information.
        ///
        /// Providing an offset makes this an absolute instant in time around the world. The date/time will be adjusted
        /// based on the user's time zone. For example, a time of 2018-06-19T18:30:00-04:00 will be 18:30:00 for a user
        ...
        /// will be 18:30:00 for a user in New York and also 18:30:00 for a user in Los Angeles. This is useful when the
        /// same local date/time should apply to many physical locations across several time zones.</summary>
    ...
    {
        /// <summary>Identifies what kind of resource this is. Value: the fixed string
        /// "walletobjects#discoverableProgram".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; } 
    ...
    {
        /// <summary>User data that is sent in a POST request to the signup website URL. This information is encoded and
        /// then shared so that the merchant's website can prefill fields used to enroll the user for the discoverable
        /// program.</summary>
    ...
    public class EventDateTime : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        ///
        /// Both doorsOpenLabel and customDoorsOpenLabel may not be set. If neither is set, the label will default to
        /// "Doors Open", localized. If the doors open field is unset, this label will not be used.</summary>
        ...
        ///
        /// 1985-04-12T19:20:50.52-04:00 would be 20 minutes and 50.52 seconds after the 19th hour of April 12th, 1985,
        /// 4 hours before UTC (same instant in time as the above example). If the event were in New York, this would be
        /// the equivalent of Eastern Daylight Time (EDT). Remember that offset varies in regions that observe Daylight
        ...
        /// <summary>The date/time when the event ends. The event spans multiple days, it should be the end date/time on
        /// the last day.
        ///
        /// This is an ISO 8601 extended format date/time, with or without an offset. Time may be specified up to
        /// nanosecond precision. Offsets may be specified with seconds precision (even though offset seconds is not
    ...
    public class EventTicketClass : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        public virtual CommonWalletObjectClassCallbackOptions CallbackOptions { get; set; } 

        /// <summary>The label to use for the confirmation code value
        /// (eventTicketObject.reservationInfo.confirmationCode) on the card detail view. Each available option maps to
        /// a set of localized strings, so that translations are shown to the user based on their locale.
        ///
        /// Both confirmationCodeLabel and customConfirmationCodeLabel may not be set. If neither is set, the label will
        ...
        /// <summary>A custom label to use for the gate value (eventTicketObject.seatInfo.gate) on the card detail view.
        /// This should only be used if the default "Gate" label or one of the gateLabel options is not sufficient.
        ///
        ...
        /// <summary>A custom label to use for the seat value (eventTicketObject.seatInfo.seat) on the card detail view.
        /// This should only be used if the default "Seat" label or one of the seatLabel options is not sufficient.
        ///
        ...
        /// <summary>A custom label to use for the section value (eventTicketObject.seatInfo.section) on the card detail
        /// view. This should only be used if the default "Section" label or one of the sectionLabel options is not
        /// sufficient.
        ///
        ...
        /// <summary>The name of the event, such as "LA Dodgers at SF Giants".</summary>
        ...
        /// <summary>The label to use for the gate value (eventTicketObject.seatInfo.gate) on the card detail view. Each
        ...
        /// RGB triplet, such as #ffcc00. You can also use the shorthand version of the RGB triplet which is #rgb, such
        /// as #fc0.</summary>
        ...
        ///
        /// This is only supported by the gift cards, loyalty, and offers verticals.</summary>
        ...
        /// <summary>The status of the class. This field can be set to draft or underReview using the insert, patch, or
        /// update API calls. Once the review state is changed from draft it may not be changed back to draft.
        ///
        ...
        /// <summary>The label to use for the seat value (eventTicketObject.seatInfo.seat) on the card detail view. Each
        /// available option maps to a set of localized strings, so that translations are shown to the user based on
        /// their locale.
        ///
        /// Both seatLabel and customSeatLabel may not be set. If neither is set, the label will default to "Seat",
    ...
    public class EventTicketClassAddMessageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Container object for messages.</summary>
    ...
    {
        /// <summary>A REST resource.</summary>
    ...
    public class EventTicketClassGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual EventTicketClassMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class EventTicketClassListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual EventTicketClassMask ResultMask { get; set; } 
    ...
    public class EventTicketClassMask : Google.Apis.Requests.IDirectResponseSchema
    {
    ...
    public class EventTicketObject : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The class associated with this object. The class must be of the same type as this object, must
        /// already exist, and must be approved.
        ///
        ...
        /// regardless of the messages field, expiration notifications to the user will be suppressed. By default, this
        ...
        /// <summary>The unique identifier for an object. This ID must be unique across all objects from an issuer. This
        /// value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        ...
        /// <summary>The state of the object. This field is used to determine how an object is displayed in the
        /// app.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("state")]
        public virtual string State { get; set; } 
    ...
    public class EventTicketObjectAddMessageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Container object for messages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("message")]
        public virtual WalletObjectMessage Message { get; set; } 
    ...
    public class EventTicketObjectGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual EventTicketObjectMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class EventTicketObjectListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual EventTicketObjectMask ResultMask { get; set; } 
    ...
    public class EventTicketObjectMask : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 
    ...
    public class FlightCarrier : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A localized name of the airline specified by carrierIataCode. If unset, the localizedIssuerName or
        /// issuerName will be used for display purposes. We strongly encourage you to set this field becaue issuer name
        /// might not be same as airline name.
        ///
    ...
    public class FlightClass : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Information about the flight carrier and number.</summary>
        ...
        ///
        /// This field should be set if at least one of the below is true: - It differs from the scheduled time. Google
        /// will use it to calculate the delay. - The aircraft already arrived at the gate. Google will use it to inform
        ...
        ///
        /// This field should be set if at least one of the below is true: - It differs from the scheduled time. Google
        /// will use it to calculate the delay. - The aircraft already pulled from the gate. Google will use it to
        /// inform the user when the flight actually departed.
        ///
        /// This is an ISO 8601 extended format date/time without an offset. Time may be specified up to millisecond
        /// precision.
        ///
        ...
        /// This should be the local date/time at the airport (not a UTC time).
        ///
        /// Google will reject the request if UTC offset is provided. Timezones will be calculated by Google based on
        /// departure airport.
        ///
        /// If this is not set, Google will set it based on data from other sources.</summary>
        ...
        /// <summary>The scheduled date and time when the aircraft is expected to depart the gate (not the runway).
        ///
    ...
    public class FlightClassAddMessageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Container object for messages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("message")]
        public virtual WalletObjectMessage Message { get; set; } 
    ...
    public class FlightClassGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual FlightClassMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class FlightClassListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual FlightClassMask ResultMask { get; set; } 
    ...
    public class FlightClassMask : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 
    ...
    public class FlightObject : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Passenger name as it would appear on the boarding pass.
        ///
        ...
        /// <summary>Information about flight reservation.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("reservationInfo")]
    ...
    public class FlightObjectAddMessageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Container object for messages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("message")]
        public virtual WalletObjectMessage Message { get; set; } 
    ...
    public class FlightObjectGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual FlightObjectMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class FlightObjectListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual FlightObjectMask ResultMask { get; set; } 
    ...
    public class FlightObjectMask : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 
    ...
    public class IssuerGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual IssuerMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class IssuerListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual IssuerMask ResultMask { get; set; } 
    ...
    public class IssuerMask : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 
    ...
    {
        /// <summary>Contains the string to be displayed if no appropriate translation is available.
        ///
        /// Required for each nested object of kind walletobjects#localizedString.</summary>
    ...
    public class LoyaltyClass : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The logo of the loyalty program or company. This logo is displayed in both the details and list
        /// views of the app.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("programLogo")]
        public virtual Image ProgramLogo { get; set; } 

        /// <summary>The program name, such as "Adam's Apparel". The app may display an ellipsis after the first 20
        /// characters to ensure full string is displayed on smaller screens.</summary>
    ...
    public class LoyaltyObjectModifyLinkedOfferObjectsRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("linkedOfferObjectIds")]
        public virtual WalletObjectModifyLinkedOfferObjects LinkedOfferObjectIds { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class LoyaltyObjectModifyLinkedOfferObjectsResponse : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>A REST resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("resource")]
        public virtual LoyaltyObject Resource { get; set; } 
    ...
    {
        /// <summary>A reference to a field to display. If both firstValue and secondValue are populated, they will both
        /// appear as one item with a slash between them. For example, values A and B would be shown as "A /
        /// B".</summary>
    ...
    public class TicketLeg : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The origin station code. This is required if destinationStationCode is present or if originName is
        /// not present.</summary>
        ...
        /// <summary>The reserved seat for the passenger(s). If only one seat is to be specified then use the ticketSeat
        /// field instead. Both ticketSeat and ticketSeats may not be set.</summary>
    ...
    public class TicketSeat : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A custome fare class to be used if no fareClass applies. Both fareClass and customFareClass may not
        /// be set.</summary>
        ...
        /// <summary>The identifier of where the ticketed seat is located. Eg. "42"</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("seat")]
    ...
    public class TransitClass : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A custom label to use for the transit fare name value (transitObject.ticketLeg.fareName).</summary>
        ...
        /// <summary>A custom label to use for the boarding platform value (transitObject.ticketLeg.platform).</summary>
        ...
        /// <summary>The type of transit this class represents, such as "bus".</summary>
    ...
    public class TransitClassAddMessageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Container object for messages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("message")]
        public virtual WalletObjectMessage Message { get; set; } 
    ...
    public class TransitClassGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual TransitClassMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class TransitClassListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual TransitClassMask ResultMask { get; set; } 
    ...
    public class TransitClassMask : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 
    ...
    public class TransitObject : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>A custom concession category to use when concessionCategory does not provide the right option. Both
        /// concessionCategory and customConcessionCategory may not be set.</summary>
        ...
        /// <summary>The name(s) of the passengers the ticket is assigned to. The passengerType field is meant to give
        /// Google context on this field.</summary>
        ...
        /// information. If more than one leg is to be specified then use the ticketLegs field instead. Both ticketLeg
        /// and ticketLegs may not be set.</summary>
        ...
        /// <summary>The number of the ticket. This is a unique identifier for the ticket.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("ticketNumber")]
        public virtual string TicketNumber { get; set; } 
        ...
        /// <summary>The type of trip this transit object represents. Used to determine which symbol to use between the
    ...
    public class TransitObjectAddMessageRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>Container object for messages.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("message")]
        public virtual WalletObjectMessage Message { get; set; } 
    ...
    public class TransitObjectGetRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual TransitObjectMask ResultMask { get; set; } 

        /// <summary>The ETag of the item.</summary>
        public virtual string ETag { get; set; }
    }    

    public class TransitObjectListRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("resultMask")]
        public virtual TransitObjectMask ResultMask { get; set; } 
    ...
    public class TransitObjectMask : Google.Apis.Requests.IDirectResponseSchema
    {
        [Newtonsoft.Json.JsonPropertyAttribute("fields")]
        public virtual System.Collections.Generic.IList<FieldMask> Fields { get; set; } 
    ...
    public class TranslatedString : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Represents the BCP 47 language tag. Example values are "en-US", "en-GB", "de", or "de-AT".
        ///
        /// Required for each nested object of kind walletobjects#translatedString.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("language")]
        public virtual string Language { get; set; } 

        /// <summary>The UTF-8 encoded translated string.
        ///
        /// Required for each nested object of kind walletobjects#translatedString.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("value")]
        public virtual string Value { get; set; } 
    ...
    public class WalletObjectModifyLinkedOfferObjects : Google.Apis.Requests.IDirectResponseSchema
    {
        /// <summary>The linked offer object ids to add to the loyalty object.</summary>
        ...
        /// <summary>Identifies what kind of resource this is. Value: the fixed string
        /// "walletobjects#walletObjectModifyLinkedOfferObjects".</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind { get; set; } 

        /// <summary>The linked offer object ids to remove from the loyalty object.</summary>
...
namespace csharp.service
{
    ...
    public class WalletobjectsService : Google.Apis.Services.BaseClientService
    {
        ...
        public class Scope
        {
            ...
            /// <summary>You should never encounter this message. Please do not approve the access request.</summary>
            public static string WalletObjectSandboxIssuer = "https://www.googleapis.com/auth/wallet_object_sandbox.issuer";
    ...
    public class EventticketclassResource
    {
        ...
        public virtual AddmessageRequest Addmessage(EventTicketClassAddMessageRequest body, string resourceId)
        {
        ...
        public class AddmessageRequest : WalletobjectsBaseServiceRequest<EventTicketClassAddMessageResponse>
        {
            ...
            public AddmessageRequest(Google.Apis.Services.IClientService service, EventTicketClassAddMessageRequest body, string resourceId)
                : base(service)
            {
            ...
            EventTicketClassAddMessageRequest Body { get; set; }
            ...
            {
                get { return "eventTicketClass/{resourceId}/addMessage"; }
            }
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<EventTicketClass>
        {
            ...
            public override string RestPath
            {
                get { return "eventTicketClass/{resourceId}"; }
            }
    ...
    public class EventticketobjectResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(EventTicketObjectAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, EventTicketObjectAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// This value should follow the format issuer ID.identifier where the former is issued by Google and latter
            /// is chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or
            /// '-'.</summary>
            [Google.Apis.Util.RequestParameterAttribute("resourceId", Google.Apis.Util.RequestParameterType.Path)]
            public virtual string ResourceId { get; private set; }
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            EventTicketObjectAddMessageRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "eventTicketObject/{resourceId}/addMessage"; }
            }
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<EventTicketObject>
        {
            ...
            public override string RestPath
            {
                get { return "eventTicketObject/{resourceId}"; }
            }
        ...
        /// <summary>Returns a list of all event ticket objects for a given class ID.</summary>
        /// <param name="classId">The ID of the class whose objects will be listed.
        ///
        /// This value should follow the format issuer ID.identifier where the former is issued by Google and latter is chosen
        /// by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        ...
        public class ListRequest : WalletobjectsBaseServiceRequest<EventTicketObjectListResponse>
        {
            ...
            /// <summary>The ID of the class whose objects will be listed.
            ///
            /// This value should follow the format issuer ID.identifier where the former is issued by Google and latter
            /// is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or
            /// '-'.</summary>
    ...
    public class FlightclassResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(FlightClassAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, FlightClassAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            FlightClassAddMessageRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "flightClass/{resourceId}/addMessage"; }
            }
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<FlightClass>
        {
            ...
            public override string RestPath
            {
                get { return "flightClass/{resourceId}"; }
            }
    ...
    public class FlightobjectResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(FlightObjectAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, FlightObjectAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            FlightObjectAddMessageRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "flightObject/{resourceId}/addMessage"; }
            }
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<FlightObject>
        {
            ...
            public override string RestPath
            {
                get { return "flightObject/{resourceId}"; }
            }
        ...
        /// <summary>Returns a list of all flight objects for a given class ID.</summary>
        /// <param name="classId">The ID of the class whose objects will be listed.
        ///
        /// This value should follow the format issuer ID.identifier where the former is issued by Google and latter is chosen
        /// by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
    ...
    public class GiftcardclassResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(GiftCardClassAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, GiftCardClassAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            GiftCardClassAddMessageRequest Body { get; set; }
    ...
    public class GiftcardobjectResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(GiftCardObjectAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, GiftCardObjectAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            GiftCardObjectAddMessageRequest Body { get; set; }
    ...
    public class IssuerResource
    {
        ...
        /// <summary>Returns the issuer referenced by the given issuer ID.</summary>
        ...
        /// <summary>Inserts an issuer with the given properties.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        /// <summary>Lists all issuers shared to the caller of this API.</summary>
    ...
    public class JwtResource
    {
        ...
        /// <summary>Inserts the given JSON web token for the issuer referenced inside.</summary>
        /// <param name="body">The body of the request.</param>
        ...
        /// <summary>Inserts the given JSON web token for the issuer referenced inside.</summary>
        public class InsertRequest : WalletobjectsBaseServiceRequest<JwtResource>
        {
            /// <summary>Constructs a new Insert request.</summary>
    ...
    public class LoyaltyclassResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(LoyaltyClassAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, LoyaltyClassAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            LoyaltyClassAddMessageRequest Body { get; set; }
    ...
    public class LoyaltyobjectResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(LoyaltyObjectAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, LoyaltyObjectAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            LoyaltyObjectAddMessageRequest Body { get; set; }
        ...
        /// <summary>Add (and remove) linked offer objects, specified by ID, to the loyalty object referenced by the
        /// resource ID.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="resourceId">The unique identifier for an object. This ID must be unique across all objects from an
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual ModifylinkedofferobjectsRequest Modifylinkedofferobjects(LoyaltyObjectModifyLinkedOfferObjectsRequest body, string resourceId)
        {
        ...
        /// <summary>Add (and remove) linked offer objects, specified by ID, to the loyalty object referenced by the
        /// resource ID.</summary>
        public class ModifylinkedofferobjectsRequest : WalletobjectsBaseServiceRequest<LoyaltyObjectModifyLinkedOfferObjectsResponse>
        {
            /// <summary>Constructs a new Modifylinkedofferobjects request.</summary>
            public ModifylinkedofferobjectsRequest(Google.Apis.Services.IClientService service, LoyaltyObjectModifyLinkedOfferObjectsRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            LoyaltyObjectModifyLinkedOfferObjectsRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "loyaltyObject/{resourceId}/modifyLinkedOfferObjects"; }
            }
    ...
    public class OfferclassResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(OfferClassAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, OfferClassAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            OfferClassAddMessageRequest Body { get; set; }
    ...
    public class OfferobjectResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(OfferObjectAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, OfferObjectAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            OfferObjectAddMessageRequest Body { get; set; }
    ...
    public class PermissionsResource
    {
        ...
        /// <summary>Returns the permissions for the issuer referenced by the given issuer ID.</summary>
        /// <param name="resourceId">The unique identifier for an issuer. This ID must be unique across all
        /// issuers.</param>
        public virtual GetRequest Get(long resourceId)
        {
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<Permissions>
        {
            ...
            public override string RestPath
            {
                get { return "permissions/{resourceId}"; }
            }
        ...
        /// <summary>Updates the permissions for the issuer referenced by the given issuer ID. This method supports
        /// patch semantics.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="resourceId">The unique identifier for an issuer. This ID must be unique across all
        /// issuers.</param>
        public virtual PatchRequest Patch(Permissions body, long resourceId)
        {
            return new PatchRequest(service, body, resourceId);
        }
        ...
        /// <summary>Updates the permissions for the issuer referenced by the given issuer ID. This method supports
        /// patch semantics.</summary>
        public class PatchRequest : WalletobjectsBaseServiceRequest<Permissions>
        {
            /// <summary>Constructs a new Patch request.</summary>
            public PatchRequest(Google.Apis.Services.IClientService service, Permissions body, long resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
        ...
        /// <summary>Updates the permissions for the issuer referenced by the given issuer ID.</summary>
        /// <param name="body">The body of the request.</param>
        /// <param name="resourceId">The unique identifier for an issuer. This ID must be unique across all
        /// issuers.</param>
    ...
    public class TransitclassResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(TransitClassAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, TransitClassAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            TransitClassAddMessageRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "transitClass/{resourceId}/addMessage"; }
            }
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<TransitClass>
        {
            ...
            public override string RestPath
            {
                get { return "transitClass/{resourceId}"; }
            }
        ...
        /// <summary>Inserts an transit class with the given ID and properties.</summary>
        /// <param name="body">The body of the request.</param>
    ...
    public class TransitobjectResource
    {
        ...
        /// issuer. This value should follow the format issuer ID.identifier where the former is issued by Google and latter is
        /// chosen by you. The unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
        public virtual AddmessageRequest Addmessage(TransitObjectAddMessageRequest body, string resourceId)
        {
            return new AddmessageRequest(service, body, resourceId);
        }
        ...
        {
            /// <summary>Constructs a new Addmessage request.</summary>
            public AddmessageRequest(Google.Apis.Services.IClientService service, TransitObjectAddMessageRequest body, string resourceId)
                : base(service)
            {
                ResourceId = resourceId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            TransitObjectAddMessageRequest Body { get; set; }
            ...
            public override string RestPath
            {
                get { return "transitObject/{resourceId}/addMessage"; }
            }
        ...
        public class GetRequest : WalletobjectsBaseServiceRequest<TransitObject>
        {
            ...
            public override string RestPath
            {
                get { return "transitObject/{resourceId}"; }
            }
        ...
        /// <summary>Returns a list of all transit objects for a given class ID.</summary>
        /// <param name="classId">The ID of the class whose objects will be listed.
        ///
        /// This value should follow the format issuer ID.identifier where the former is issued by Google and latter is chosen
        /// by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.</param>
